  ...
  return (
    ...
    >
      ...
      <p className="mb-4 text-xs text-papa-muted">
        Same info you’d use in the Excel sign-up: status, phone, when you can
        help, and travel if needed.
      </p>
      ...
      <div className="mt-4 flex flex-col gap-3">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="h-4 w-4 rounded border-papa-border text-papa-navy"
          />
          <label htmlFor="flight_voucher_requested" className="text-sm text-foreground">
