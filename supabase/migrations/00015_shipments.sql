-- Shipments: track packages (USPS, UPS, FedEx, DHL via Ship24), admin-managed
...
comment on column public.shipments.carrier is 'Shipping carrier: USPS, UPS, FEDEX, or DHL.';
